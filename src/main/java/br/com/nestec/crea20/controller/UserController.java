...
public class UserController {
    ...
    @GetMapping(path = "/listusuarios") @DenyAll() @ValidateUserAnnotation
    ...
    @DeleteMapping (path = "/usuario/deletar") @ValidateUserAnnotation
    public void deleteUser(@RequestParam String cpf){
        userService.deleteUser(cpf);
    }

    @PostMapping (path = "/funcao/salvar") @ValidateUserAnnotation
    ...
    @DeleteMapping (path = "/funcao/deletar") @ValidateUserAnnotation
    public void deleteRole(@RequestParam String nome){
        userService.deleteRole(nome);
    }

    @PostMapping (path = "/funcao/addaousuario") @ValidateUserAnnotation
